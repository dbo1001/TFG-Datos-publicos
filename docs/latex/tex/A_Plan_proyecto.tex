...
Para la organización del proyecto se ha utilizado \foothref{GitHub}{https://github.com/IvanArjona/TFG-Datos-publicos} junto con la extensión de \foothref{ZenHub}{https://www.zenhub.com/} para asignar prioridades a las tareas y realizar gráficos del trabajo pendiente de cada iteración.
...
Se realizó el despliegue utilizando estas plataformas. \foothref{Web desplegada}{http://tfg-datos-publicos.nanoapp.io/}.
...
Este sprint se dedicó a empezar a documentar la memoria y corregir algunos errores en la página de consulta como el reenvio de formularios en \textit{Firefox} y la descarga de consultas en JSON y CSV.
...
\imagen{sprints/sprint10}{Burndown del sprint 10}

\foothref{Tareas del sprint 10 en Github}{https://github.com/IvanArjona/TFG-Datos-publicos/milestone/11?closed=1}
...
%\imagen{sprints/sprint11}{Burndown del sprint 11}

\foothref{Tareas del sprint 11 en Github}{https://github.com/IvanArjona/TFG-Datos-publicos/milestone/12?closed=1}
...
\begin{itemize}
	...
	\item Profesor titular de universidad. Sueldo mensual: \EUR{3.527,89}. Imparte 24 créditos anuales.
	$$ \dfrac{\textup{\EUR{3.527,89}} * 12 \;meses * 0.5 \;créditos}{24 \;créditos} = \textup{\EUR{881,97}} $$
\end{itemize}

Corresponde un total de \EUR{7592,59} de personal y \EUR{1335,87} de los tutores.
...
Como software incluimos la licencia de \textit{Windows} como único pago y las licencias de \textit{Github developer}, \textit{Codacy Pro} y \textit{PyCharm} como pago mensual. \textit{Gitkraken Pro} supone un coste de \EUR{41} anual, como no hay pago mensual, se considerará el pago completo. (Ver tabla \ref{tab:costessoftware})
