...
\noindent D. José Francisco Díez Pastor y D. Jesús Manuel Maudes Raedo, profesores del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos.

\noindent Exponen:

\noindent Que el alumno D. \nombre, con DNI 71352655P, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado ``Aplicación Web para la recopilación, tratamiento y visualización de datos públicos''. 
